 ...
 * {@link SingleRecordViewFragmentListener} interface
...
public class ViewRecordSingleFragment extends AddRecordFullFragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof SingleRecordViewFragmentListener) {
            mCallback = (SingleRecordViewFragmentListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement SingleRecordViewFragmentListener");
        }
    }
     ...
     */
    public interface SingleRecordViewFragmentListener {
        void onSingleRecordViewRequest(int request);
    }
